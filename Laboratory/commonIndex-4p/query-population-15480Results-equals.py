import time
from helper import execute_aggregation, JSONEncoder
                           ...
                           "operator": {
                               "compound": {
                                   "filter": [
                                       ...
                                       {"equals": {"path": "sn.a", "value": 18 }},
                                       {"equals": {"path": "sn.a", "value": 10000 }},
                                       {"equals": {"path": "sn.a", "value": 20000 }},
                                       {"equals": {"path": "sn.a", "value": 30000 }},
                                       {"equals": {"path": "sn.a", "value": 19 }},
...
#                                    "filter": [
#                                        {"equals": {"path": "sn.d.ani", "value": 240000}},
#                                        {"equals": {"path": "sn.a", "value": 16 }},
#                                        {"equals": {"path": "sn.a", "value": 17 }},
#                                        {"equals": {"path": "sn.a", "value": 18 }},
#                                        {"equals": {"path": "sn.a", "value": 10000 }},
#                                        {"equals": {"path": "sn.a", "value": 20000 }},
#                                        {"equals": {"path": "sn.a", "value": 30000 }},
...
#                                    "filter": [
#                                        {"equals": {"path": "sn.d.ani", "value": 10000}},
#                                        {"in": {"path": "sn.a", "value": [16,17,18,10000,20000,30000,19]}},
#                                        {"equals": {"path": "sn.d.v.v", "value": "Negatiu"}}
#                                    ]
#                                }
#                            }
...
#                                    "filter": [
#                                        {"equals": {"path": "sn.d.ani", "value": 110000}},
#                                        {"in": {"path": "sn.a", "value": [16,10000,3,50000]}},
#                                        {"equals": {"path": "sn.d.v.df.cs", "value": "H43001903"}}
#                                    ]
#                                }
#                            }
...
#    }
#]
results = execute_aggregation("CatSalutCDR.finalSearch", pipeline)
